...
class _LoadMoreState extends State<LoadMore> {
  ...
  Widget build(BuildContext context) {
    ...
    if (child is ReorderableSliverList) {
      return _buildReorderableSliverList(child as ReorderableSliverList);
    }
    return child;
  }
  ...
  Widget _buildReorderableSliverList(ReorderableSliverList list) {
    final delegate = list.delegate;
