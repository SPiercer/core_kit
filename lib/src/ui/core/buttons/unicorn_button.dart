...
class UnicornButton extends FloatingActionButton {
  ...
  UnicornButton(
      ...
      this.hasLabel = false})
      : super(key: key, onPressed: currentButton.onPressed);
  ...
  Widget build(BuildContext context) {
    ...
    var mainFAB = AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        return Transform(
          transform: Matrix4.diagonal3(vector.Vector3(_parentController.value,
              _parentController.value, _parentController.value)),
